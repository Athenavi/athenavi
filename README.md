<div align="center">
  <h1>athenavi - 轻量易用的Python Flask博客系统</h1>
...
[![GitHub Stars](https://img.shields.io/github/stars/Athenavi/athenavi.svg?style=social)](https://github.com/Athenavi/athenavi/stargazers)
...
```bash
# 克隆仓库
git clone https://github.com/Athenavi/athenavi.git
cd athenavi
...
![Star History Chart](https://api.star-history.com/svg?repos=Athenavi/athenavi&type=Date)
...
- 问题反馈：[GitHub Issues](https://github.com/Athenavi/athenavi/issues)
- 社区讨论：QQ群（暂未开放）
